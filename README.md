...
For demo purposes only --> multi-tenant insurance member portal built with **dbt Semantic Layer**, **Snowflake**, and **Streamlit**. This app demonstrates secure AI-powered analytics with row-level security, company-scoped tokens, and comprehensive audit logging.
